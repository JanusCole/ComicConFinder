    ...
    public void testRetrofitWithGoodResponse() throws Exception {
        ...
        retrofitConsFromWeb.getConventionEvents(new ConventionsEventService.ConventionEventsCallback() {
            ...
            public void onConventionsComplete(List<Convention> conventions) {
                ...
                assertEquals("2018-12-29", oneConvention.getDates());
                assertEquals("Austin, USA", oneConvention.getLoc());
                assertEquals("http://fancons.com/events/info.shtml/9192/Ikkicon_2018/", oneConvention.getUrlname());
