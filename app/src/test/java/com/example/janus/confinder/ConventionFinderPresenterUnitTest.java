...
public class ConventionFinderPresenterUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        conventionMapperPresenter = new ConventionMapperPresenter(mockConventionFinderView, conventionsEventService);
...
/*    @Test
    ...
    public void testGetConventionsEventError() throws Exception {
        ...
        List<Convention> mockConventionEvents = new ArrayList<>();
        //mockConventionEvents.add(new Convention());
